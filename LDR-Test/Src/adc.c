...
void SingleReadMultiChannelADCInterrupt(ADCxPort *ADC_port) {
	...
	if (((ADC_port->ADCx->ISR & ADC_ISR_EOC) != 0) && (ADC_port->value_4 == 0)){
		while (ADC_port->conversion_counter <= ADC_port->NumChannels) {
			if (ADC_port->conversion_counter == 0) {
				ADC_port->value_1 = ADC_port->ADCx->DR;
			}
			else if (ADC_port->conversion_counter == 1) {
				ADC_port->value_2 = ADC_port->ADCx->DR;
			}
			else if (ADC_port->conversion_counter == 2) {
				ADC_port->value_3 = ADC_port->ADCx->DR;
			}
			else if (ADC_port->conversion_counter == 3) {
		...
		if (((ADC_port->ADCx->ISR & ADC_ISR_EOC) != 0) && (ADC_port->value_4 == 0)){
			while (ADC_port->conversion_counter <= ADC_port->NumChannels) {
				if (ADC_port->NumChannels == 0) {
					ADC_port->value_1 = ADC_port->ADCx->DR;
					ADC_port->conversion_counter++;
				}
				else if (ADC_port->NumChannels == 1) {
					ADC_port->value_1 = ADC_port->ADCx->DR;
					ADC_port->conversion_counter++;
					ADC_port->value_2 = ADC_port->ADCx->DR;
					ADC_port->conversion_counter++;
				}
				else if (ADC_port->NumChannels == 2) {
					ADC_port->value_1 = ADC_port->ADCx->DR;
					ADC_port->conversion_counter++;
					ADC_port->value_2 = ADC_port->ADCx->DR;
					ADC_port->conversion_counter++;
				...
				else if (ADC_port->NumChannels == 3) {
					ADC_port->value_1 = ADC_port->ADCx->DR;
					ADC_port->conversion_counter++;
					ADC_port->value_2 = ADC_port->ADCx->DR;
					ADC_port->conversion_counter++;
